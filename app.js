...
class Animations {
  static title() {
    ...
    tm.to("#random-txt", {
      ...
      .to("#curse-txt", {
        ...
        duration: 0,
        delay: 0.1,
        onComplete: Animations.titleDisplay,
      })
      .to(".pentagram-cont", {
        opacity: 1,
        duration: 2,
        delay: 1,
        onStart: Animations.pentagramDisplayOn,
      })
  ...
  static cursesInOut() {
    ...
    tl.to(".curse", {
      duration: 0.25,
      opacity: 0,
      onComplete: Animations.displayCurse,
  ...
  static curseIs() {
    ...
    gsap.fromTo(
      "curse-title",
      { opacity: 0 },
      { opacity: 1, duration: 1, delay: 0.2, onStart: changeTxt }
    );
  }
  ...
  static master() {
    ...
    tl.to("#flame-instructions", { duration: 1, opacity: 0 })
      ...
      .to(".pentagram-cont", {
        ...
        opacity: 0,
        ease: "power2.in",
        onComplete: Animations.pentagramDisplay,
      })
      .to(".curse-cont", {
        duration: 6,
        delay: -1.5,
        opacity: 1,
        ease: "power4.out",
        onStart: Animations.cursesInterval,
      });
  }
